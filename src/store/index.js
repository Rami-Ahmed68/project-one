...
إذا كنت ولي أمري، أضف P: بريدك الإلكتروني`,
    ...
    APIs: {
      ...
      plans: {
        ...
        admin: {
          create: "https://rrr-zb8x.onrender.com/api/v1/admin/plan/create",
          delete: "https://rrr-zb8x.onrender.com/api/v1/admin/plan/delete",
          update: "https://rrr-zb8x.onrender.com/api/v1/admin/plan/update",
        },
        teacher: {
          copyORremove:
