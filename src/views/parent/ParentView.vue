<template>
  <div
    :class="`parent-page-${this.$store.state.mood}-${this.$store.state.language}`"
  >
    ...
    <div :class="this.status ? 'cont-open' : 'cont-close'">
      ...
      <div class="section-tow" v-if="this.$store.state.show_user.data">
        ...
        >
          {{
            this.$store.state.language == "English"
              ? this.$store.state.English.show_user_page
                  .default_message_children
              : this.$store.state.Arabic.show_user_page.default_message_children
          }}
        </p>
        <!-- default results messgaes  -->
      </div>
...
.parent-page-darck-Arabic {
  @extend .parent-page-darck-English;
  direction: rtl;
}

.parent-page-light-Arabic {
  @extend .parent-page-light-English;
  direction: rtl;
}
// Darck and light Arabic style
</style>
