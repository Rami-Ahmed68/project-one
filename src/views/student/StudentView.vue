<template>
  <div
    :class="`student-page-${this.$store.state.mood}-${this.$store.state.language}`"
  >
      ...
      <div class="section-one" v-if="this.$store.state.show_user.data">
        ...
        <div class="info">
          ...
          <h3>
            {{
              this.$store.state.language == "English"
                ? this.$store.state.English.show_user_page.points
                : this.$store.state.Arabic.show_user_page.points
            }}
            {{ this.$store.state.show_user.data.points }}
          </h3>
          <!-- points  -->
          ...
          <h3>
            {{
              this.$store.state.language == "English"
                ? this.$store.state.English.show_user_page.gpa
                : this.$store.state.Arabic.show_user_page.gpa
            }}
            {{ this.$store.state.show_user.data.total_gpa }}
          </h3>
          <!-- GPA  -->
        </div>
        ...
        <div class="notes">
          ...
          <p>
            {{
              this.$store.state.language == "English"
                ? this.$store.state.English.show_user_page.exams
                : this.$store.state.Arabic.show_user_page.exams
            }}
            {{ this.$store.state.show_user.data.finished_exams }}
          </p>
          <!-- exams  -->
          ...
          <p
            v-if="
              ...
              (this.$store.state.user.user_type == 'student' &&
                this.$store.state.user.user.gender ===
                  this.$store.state.show_user.data.gender)
            "
          >
            {{
        ...
        <div class="medals">
          ...
          >
            {{
              this.$store.state.show_user.data.total_gpa >= medal.gpa
                ? this.$store.state.language == "English"
                  ? medal.English
                  : medal.Arabic
                : "🔒"
...
.student-page-darck-Arabic {
  @extend .student-page-darck-English;
  direction: rtl;
}

.student-page-light-Arabic {
  @extend .student-page-light-English;
  direction: rtl;
}
// Darck and light Arabic style
</style>
