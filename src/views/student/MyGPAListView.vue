  ...
  >
    ...
    <div :class="this.status ? 'open-cont' : 'close-cont'">
      ...
      <div class="header">
        {{
          this.$store.state.language == "English"
            ? this.$store.state.English.my_gpa_page.title
            : this.$store.state.Arabic.my_gpa_page.title
        }}
      </div>
      <!-- header -->
      ...
      >
        ...
        >
          <h3>
            {{
              this.$store.state.language == "English"
                ? this.$store.state.English.my_gpa_page.gpa
                : this.$store.state.Arabic.my_gpa_page.gpa
            }}
            {{ line.total_gpa }}
          </h3>
          ...
          <p>
            {{
              this.$store.state.language == "English"
                ? this.$store.state.English.my_gpa_page.points
                : this.$store.state.Arabic.my_gpa_page.points
            }}
            {{ line.points }}
          </p>
          ...
          <p>
            {{
              this.$store.state.language == "English"
                ? this.$store.state.English.my_gpa_page.exams
                : this.$store.state.Arabic.my_gpa_page.exams
            }}
            {{ line.finished_exams }}
          </p>
          ...
          <p>
            {{
              this.$store.state.language == "English"
                ? this.$store.state.English.my_gpa_page.date
                : this.$store.state.Arabic.my_gpa_page.date
            }}
            {{ line.date }}
          </p>
        </div>
      ...
      >
        {{
          this.$store.state.language == "English"
            ? this.$store.state.English.my_gpa_page.default_message
            : this.$store.state.Arabic.my_gpa_page.default_message
        }}
      </div>
      <!-- default message  -->
      <!-- section -->
